...
This application demonstrates how the Watson Assistant (formerly Conversation) service uses intent capabilities in an animated car dashboard UI.
...
2 In IBM Cloud, [create a Watson Assistant (Conversation) Service](https://console.bluemix.net/docs/services/conversation/getting-started.html#gettingstarted).
